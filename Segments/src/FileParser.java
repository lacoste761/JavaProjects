...
public class FileParser {
     ...
     * */
    public static List<Segment> getSegmentsFromFile(String fileName) throws CustomException
    {
        /*=================Чтение из файла====================*/
        List<String> content;
        try
        ...
        int nSegments = firstStringData.get(0);

        if(content.size() < nSegments + 1)
            throw new NotEnoughDataException(
                    "Not enough segments in file.\n" +
                            "ADVICE: Correct a file content and try again.");
        /*====================================================*/
        ...
        try
        {
            for(int i = 0; i < nSegments; i++)
                segments.add(new Segment(parseStringToDoubles(content.get(i + 1), 4)));
        }
        catch (NumberFormatException e)
        {
            throw new CustomNumberFormatException(
